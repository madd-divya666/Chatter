...
function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post(
        "https://chatter-backend-ybhv.onrender.com/api/user/signup",
        userInfo
      )
      .then((response) => {
        if (response.data) {
      ...
      <div className="flex h-screen justify-center items-center">
        ...
        >
          <h1 className="text-2xl text-center ">
            CHAT<span className="text-green-500 font-semibold">TER</span>
          </h1>
          ...
          <div className="flex   justify-between">
            ...
            <input
              type="submit"
              value="Signup"
              className="bg-green-500 px-2 py-1 rounded-md cursor-pointer text-white"
            />
          </div>
        </form>
      </div>
